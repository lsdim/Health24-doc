...
2. ГРУПУВАННЯ ТА УНІФІКАЦІЯ:
   ...
   - Якщо назва інструменту написана з помилкою або різною кількістю пробілів — уніфікуй її до стандартної медичної назви.
   - Для ММТ та Гоніометрії зберігай деталізацію (наприклад, "ММТ правої нижньої кінцівки").

3. ОЧИЩЕННЯ ДАНИХ:
   - Ігноруй службові слова інтерфейсу: "clear", "Назва інструменту", "Під час...", символи "?" та "****************".
